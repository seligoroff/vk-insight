...
Получает и выводит информацию о всех группах из списка `vk-groups.csv`. Команда резолвит короткие имена групп в ID и получает полную информацию о каждой группе. Полезно для проверки корректности списка групп и получения их ID.
